  ...
  var nav = {
    ...
    keyboard: (function() {
      bind(document, 'keydown', function(e) {
        ...
        console.log("-->> keydown! e.which: " + e.which + ", current: " + nav.mouse.current());
