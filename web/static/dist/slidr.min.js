...
0)+42,d=(z(b)?k.O(a.a):0)+42,e=h(b,"width"),f=h(b,"height"),l=h(b,"min-width"),n=h(b,"min-height"),c={width:"auto"===e||e===c||0!==l&&"auto"!=l,height:"auto"===f||f===d||0!==n&&"auto"!=n};a.a.parentNode.removeChild(b);return c},wa:function(a){return h(a,"margin-left")+h(a,"margin-right")},oa:function(a){return h(a,"margin-top")+h(a,"margin-bottom")},xa:function(a){return h(a,"padding-left")+h(a,"padding-right")},pa:function(a){return h(a,"padding-top")+h(a,"padding-bottom")},va:function(a){return h(a,
"border-left-width")+h(a,"border-right-width")},na:function(a){return h(a,"border-top-width")+h(a,"border-bottom-width")},P:function(a){return k.xa(a)+k.va(a)},O:function(a){return k.pa(a)+k.na(a)},da:function(a){var b=h(a,"width");e.j()&&"auto"===b&&a.offsetWidth&&(b=a.offsetWidth);"auto"!==b&&(b+=k.wa(a)+(z(a)?0:k.P(a)));return b},ca:function(a){var b=h(a,"height");e.j()&&"auto"===b&&a.offsetHeight&&(b=a.offsetHeight);"auto"!==b&&(b+=k.oa(a)+(z(a)?0:k.O(a)));return b},ga:function(a,b){var c=b;"auto"!==
b&&""!==b&&(c=b+(z(a)?k.P(a):0)+"px");h(a,{width:c});return b},fa:function(a,b){var c=b;"auto"!==b&&""!==b&&(c=b+(z(a)?k.O(a):0)+"px");h(a,{height:c});return b}},s={h:{l:[],ea:function(a){return 0<=x(s.h.l,a)},add:function(a){s.h.ea(a)||s.h.l.push(a)},remove:function(a){s.h.ea(a)&&s.h.l.splice(x(s.h.l,a),1)},c:function(){for(var a=s.h.l[s.h.l.length-1],b=0,c=s.h.l.length,d=s.h.l[b];b<c;b++)I(a,d)&&(a=d);return a},ua:function(a){w(a,"mouseenter",function(a){s.h.add(e.m(a).currentTarget.id)});w(a,"mouseleave",
function(a){s.h.remove(e.m(a).currentTarget.id)})}},ya:function(){w(document,"keydown",function(a){a=e.m(a);if(s.h.c()&&40>=a.which&&37<=a.which){var b=B[s.h.c()],c=null;40===a.which&&b.canSlide("down")?c="down":39===a.which&&b.canSlide("right")?c="right":38===a.which&&b.canSlide("up")?c="up":37===a.which&&b.canSlide("left")&&(c="left");c&&b.slide(c)&&e.stop(a)}})}(),ta:function(a){var b,c,d,g,f,h;w(a.a,"touchstart",function(a){a=e.m(a);b=a.touches[0].pageX;c=a.touches[0].pageY;d=+new Date;h=f=g=
0});w(a.a,"touchmove",function(a){a=e.m(a);1<a.touches.length||a.scale&&1!==a.scale||(g=a.touches[0].pageX-b,f=a.touches[0].pageY-c,h=+new Date-d,100<h&&0.25>(Math.abs(g)+Math.abs(f))/h||e.stop(a))});w(a.a,"touchend",function(b){b=e.m(b);if(250>Number(+new Date-d)){var c=Math.abs(g),h=Math.abs(f),k=20<c,l=20<h,m=0>g?"right":"left",p=0>f?"down":"up";(c=k&&l?c>h?m:p:k?m:l?p:null)&&q.q(a,c);e.stop(b)}})}},q={start:function(a,b){if(!a.t&&a.a){var c=h(a.a,"display"),d=h(a.a,"position"),e=h(a.a,"opacity");
h(a.a,{visibility:"visible",opacity:e,filter:"alpha(opacity="+100*e+")",display:"inline-block"===c||"inline"===c?"inline-block":"block",position:"static"===d?"relative":d,overflow:a.d.overflow?h(a.a,"overflow"):"hidden",transition:"height 0.05s ease-out, width 0.05s ease-out","tap-highlight-color":"rgba(0, 0, 0, 0)","touch-callout":"none"});a.start||q.add(a,a.d.direction,l.find(a,!0),a.d.transition);l.get(a,b)&&(a.start=b);l.display(a);k.ka(a);u.ba(a,a.a);a.d.keyboard&&s.h.ua(a.a);a.d.touch&&s.ta(a);
a.t=!0;m.update(a)}},M:function(a,b){return a.t&&b&&(l.G(b)?!!l.get(a,a.c,b):!!l.get(a,b))},q:function(a,b){q.M(a,b)&&l.q(a,b)},add:function(a,b,c,d,e){if(a.a){d=t.K(a,d);var f=l.find(a),h="horizontal"===b||"h"===b?"left":"up",k="horizontal"===b||"h"===b?"right":"down";l.K(a,c,d,f,h,k)||e?l.add(a,c,d,f,h,k):console.warn("[Slidr] Error adding ["+b+"] slides for ["+a.id+"].")}},r:function(a,b,c){a.t&&l.G(c)&&(q.stop(a),a.r=setInterval(function(){l.q(a,c)},b))},stop:function(a){a.t&&a.r&&(clearInterval(a.r),
a.r=null)},g:function(a){if(a.g&&a.u){var b="0"===h(a.g,"opacity")?"in":"out";u.A(a,null,"fade",b,null,a.g,"3","none");a.controls&&v(a.controls,"in"===b?"add":"rm","breadcrumbs")}},controls:function(a,b){if(a.controls&&a.u){m.valid(b)||(b=null);var c="hidden"===h(a.controls,"visibility"),d=b&&"none"!==b?"in":"out";"out"===d&&c||("border"===b?v(a.controls,"add","border"):"corner"===b&&v(a.controls,"rm","border"),u.A(a,null,"fade",d,null,a.controls,"2","none"))}}};setInterval(function b(){var c,d,g,
f,m;for(g in k.k)(d=k.k[g],c=d.src,e.j()||I(document,c.a))?"hidden"===h(c.a,"visibility")?(k.k[g].V=k.ga(c.a,0),k.k[g].Q=k.fa(c.a,0)):l.get(c,c.c)&&(f=l.get(c,c.c).n,m=k.da(f),f=k.ca(f),d.$.width&&d.V!=m&&(k.k[g].V=k.ga(c.a,m)),d.$.height&&d.Q!=f&&(k.k[g].Q=k.fa(c.a,f))):(delete k.k[g],delete B[c.id]);return b}(),250);var B={},M={after:H,before:H,breadcrumbs:!1,controls:"border",direction:"horizontal",fade:!0,keyboard:!1,overflow:!1,theme:"#fff",timing:{},touch:!1,transition:"linear"},N={none:"none",
